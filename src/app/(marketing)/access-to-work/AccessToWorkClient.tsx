    ...
    <div style={S.page}>
      ...
      <footer style={S.footer}>
        ...
        <div style={{ display: 'flex', gap: 24 }}>
          {[['Privacy','/privacy'],['Terms','/terms'],['For Employers','/enterprise'],['For Schools','/schools'],['Pricing','/pricing'],['vs Grammarly','/vs/grammarly'],['vs ClaroRead','/vs/claroread'],['vs Immersive Reader','/vs/immersive-reader']].map(([l,h]) => (
