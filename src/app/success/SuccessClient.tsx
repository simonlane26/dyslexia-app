...
export default function SuccessClient(): JSX.Element {
  ...
  // Refresh Clerk user so Pro badge/metadata appear immediately
  const { user } = useUser();
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <ul style={{ color: '#64748b', fontSize: '1rem', marginBottom: '2rem', lineHeight: 1.8, textAlign: 'left', paddingLeft: '1.5rem' }}>
        ...
        <div style={{ color: '#94a3b8', fontSize: '0.75rem' }}>
          Need help? <a href="mailto:support@dyslexiawrite.com" style={{ color: '#3b82f6' }}>Contact support</a>
        </div>
      </div>
    </div>
  );
