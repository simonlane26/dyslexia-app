      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            })(window,document,'script','dataLayer','GTM-PC6H3CFG');`,
          }}
        />
        ...
        `}</Script>
        {/* Meta Pixel is fired via the GTM Custom HTML tag, not installed directly here —
            keeping both would double-count every pageview and conversion event. */}
      </head>
      <body className={inter.className}>
        {/* Google Tag Manager (noscript) */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PC6H3CFG"
            height="0"
            width="0"
